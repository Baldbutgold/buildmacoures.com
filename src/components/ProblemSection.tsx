  ...
  return (
    <Section className="bg-gradient-to-br from-gray-900 via-brand-black to-gray-900">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="bg-gradient-to-br from-brand-black/50 to-gray-900/50 backdrop-blur-sm rounded-3xl shadow-xl p-8 md:p-12 mb-12 border border-brand-purple/20">
          <div className="text-center mb-10">
            <div className="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-br from-brand-purple to-brand-purple-dark rounded-full mb-6">
              <Download className="w-10 h-10 text-white" />
            </div>
            <h3 className="text-2xl md:text-3xl font-bold text-brand-white mb-4">
              Download the Free Course Blueprint
            </h3>
            <p className="text-xl text-brand-gray font-medium max-w-2xl mx-auto mb-8">
            ...
            <button className="group inline-flex items-center justify-center gap-3 px-8 py-4 bg-gradient-to-r from-brand-purple to-brand-purple-dark hover:from-brand-purple-dark hover:to-brand-purple-deep text-white font-bold text-lg rounded-full transition-all duration-300 transform hover:-translate-y-1 shadow-purple-lg hover:shadow-purple">
