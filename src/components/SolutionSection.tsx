      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 mb-12 sm:mb-16">
          {solutions.map((solution, index) => {
            ...
            return (
              <div key={index} className="group bg-brand-black/50 backdrop-blur-sm p-6 sm:p-8 rounded-2xl shadow-lg hover:shadow-purple-lg transition-all duration-500 border border-brand-purple/20 hover:border-brand-purple/40 transform hover:-translate-y-2">
                <div className="flex items-start gap-4 sm:gap-6">
                  <div className={`flex-shrink-0 w-12 h-12 sm:w-14 sm:h-14 rounded-xl bg-gradient-to-br ${gradientClass} flex items-center justify-center group-hover:scale-110 transition-transform duration-300`}>
                    <Icon className="w-6 h-6 sm:w-7 sm:h-7 text-white" />
                  </div>
                  <div className="flex-1">
                    <h3 className="text-lg sm:text-xl font-bold text-brand-white mb-3 group-hover:text-brand-purple transition-colors">
                      {solution.title}
                    </h3>
        ...
        <div className="text-center">
          <div className="bg-gradient-to-br from-brand-black via-gray-900 to-brand-black text-white p-6 sm:p-8 lg:p-12 rounded-3xl shadow-2xl border border-brand-purple/20">
            <h3 className="text-2xl sm:text-3xl lg:text-4xl font-bold mb-4 font-bricolage">
              You Have the Knowledge.
            </h3>
            <h4 className="text-xl sm:text-2xl lg:text-3xl font-bold text-orange-400 mb-6">
              Let Me Turn It Into Profit.
            </h4>
            <p className="text-lg sm:text-xl text-brand-gray mb-8 max-w-2xl mx-auto">
