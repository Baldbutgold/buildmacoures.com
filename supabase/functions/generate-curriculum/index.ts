...
Please ensure the curriculum is practical, achievable, and directly aligned with helping the learner reach their stated goal.`;
    ...
    // Get the generative model - using Gemini 2.0 Flash Experimental (latest available)
    ...
    console.log('Generating content with Gemini 2.0 Flash Experimental...');
    ...
    console.log('Curriculum generated successfully with Gemini 2.0');
